export const YOUTUBE_API_KEY = "AIzaSyB0hJh_HT1-xrpYZgv3jC2D8coF2DlpESo";
...
export const YOUTUBE_SEARCH_SUGGESTIONS = `https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=5&q=`